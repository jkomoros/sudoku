...
func TestXWingRow(t *testing.T) {
	options := solveTechniqueTestHelperOptions{
		targetCells:  []CellReference{{1, 4}, {1, 7}, {8, 4}},
		pointerCells: []CellReference{{0, 4}, {0, 7}, {7, 4}, {7, 7}},
...
func TestXWingCol(t *testing.T) {
	options := solveTechniqueTestHelperOptions{
		transpose:    true,
		targetCells:  []CellReference{{4, 1}, {7, 1}, {4, 8}},
		pointerCells: []CellReference{{4, 0}, {7, 0}, {4, 7}, {7, 7}},
		targetNums:   IntSlice([]int{9}),
