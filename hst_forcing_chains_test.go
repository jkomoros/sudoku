...
func TestForcingChains(t *testing.T) {
	...
	tests := []multipleValidStepLoopOptions{
		{
			targetCells:  []CellReference{{0, 1}},
			targetNums:   IntSlice([]int{7}),
			pointerCells: []CellReference{{1, 0}},
		...
		},
		{
			targetCells:  []CellReference{{0, 1}},
			targetNums:   IntSlice([]int{7}),
			pointerCells: []CellReference{{5, 1}},
			pointerNums:  IntSlice([]int{1, 2}),
		...
		{
			targetCells:  []CellReference{{1, 0}},
			targetNums:   IntSlice([]int{1}),
			pointerCells: []CellReference{{0, 1}},
		...
		},
		{
			targetCells:  []CellReference{{1, 0}},
			targetNums:   IntSlice([]int{1}),
			pointerCells: []CellReference{{0, 6}},
			pointerNums:  IntSlice([]int{3, 7}),
			extra:        5,
		},
		{
			targetCells:  []CellReference{{1, 8}},
		...
		},
		{
			targetCells:  []CellReference{{1, 8}},
			targetNums:   IntSlice([]int{4}),
			pointerCells: []CellReference{{4, 0}},
			pointerNums:  IntSlice([]int{1, 2}),
			extra:        6,
		},
		{
		...
		},
		{
			targetCells:  []CellReference{{1, 8}},
			targetNums:   IntSlice([]int{4}),
			pointerCells: []CellReference{{5, 7}},
			pointerNums:  IntSlice([]int{1, 3}),
			extra:        6,
		},
		{
			targetCells:  []CellReference{{4, 0}},
		...
		{
			targetCells:  []CellReference{{4, 5}},
			targetNums:   IntSlice([]int{7}),
			pointerCells: []CellReference{{5, 4}},
			pointerNums:  IntSlice([]int{2, 3}),
			extra:        6,
		},
		{
			targetCells:  []CellReference{{5, 1}},
			targetNums:   IntSlice([]int{1}),
			pointerCells: []CellReference{{0, 1}},
			pointerNums:  IntSlice([]int{2, 7}),
			extra:        5,
		...
		{
			targetCells:  []CellReference{{8, 3}},
			targetNums:   IntSlice([]int{7}),
			pointerCells: []CellReference{{8, 7}},
			pointerNums:  IntSlice([]int{1, 2}),
			extra:        6,
		},
