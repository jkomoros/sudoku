...
func (a *appOptions) defineFlags() {
	...
	a.flagSet.IntVar(&a.histogramPuzzleCount, "histogram-count", 0, "If number is 1 or greater, will generate that many puzzles with the final generated difficulty model and print out a histogram of stats.")
}
