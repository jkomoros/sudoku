...
func (self *obviousInCollectionTechnique) UserLikelihood() float64 {
...
func (self *nakedSingleTechnique) UserLikelihood() float64 {
...
func (self *hiddenSingleTechnique) UserLikelihood() float64 {
